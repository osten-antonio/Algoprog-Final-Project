...
class Player(pygame.sprite.Sprite):
	...
	def advanced_health(self):
		...
		health_bar = pygame.Rect(10,45,health_bar_width,20)
		transition_bar = pygame.Rect(health_bar.right,45,transition_width,20)
		
		pygame.draw.rect(screen,(255,0,0),health_bar)
		pygame.draw.rect(screen,transition_color,transition_bar)	
		pygame.draw.rect(screen,(255,255,255),(10,45,self.health_bar_length,20),4)	
